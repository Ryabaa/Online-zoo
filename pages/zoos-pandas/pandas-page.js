...
<aside class="aside">
    <div class="aside-container">
        <a href="#/zoos/pandas" id="zoos_pandas_link" class="aside-link">
    ...
    <div class="aside-container">
        <a href="#/zoos/eagles" id="zoos-eagles_link" class="aside-link">
    ...
    <div class="aside-container">
        <a href="#/zoos/gorillas" id="zoos-gorillas_link" class="aside-link">
            <img class="aside-link__img" src="./assets/images/gorrilas.png" alt="">
        </a>
        <h3 class="aside-name">gorillas</h3>
    </div>
    <div class="aside-container">
        <a href="#/zoos/alligators" id="zoos-alligators_link" class="aside-link">
...
<button class="donate-open donate-btn">Donate to volunteers</button>
</section>
`;

export default zoosPage_pandas;
